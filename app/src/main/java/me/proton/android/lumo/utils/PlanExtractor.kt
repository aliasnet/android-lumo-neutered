                        ...
                        try {
                            ...
                            if (productId != null) {
                                val durationText = when (cycle) {
                                    1 -> context?.getString(R.string.plan_duration_1_month) ?: "1 month"
                                    12 -> context?.getString(R.string.plan_duration_12_months) ?: "12 months"
                                    else -> context?.getString(R.string.plan_duration_n_months, cycle) ?: "$cycle Months"
                                }
